...
const Services = () => {
  return (
<section id="service" className="relative w-full min-h-screen py-24 px-12 md:px-24 -mb-40">
  ...
  <div className="w-full max-w-[1300px] mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-2 gap-y-32 items-center justify-center mx-auto mt-16">

      {/* Row 1, Col 1 - Layanan Desain */}
      <div className="flex flex-col items-center text-center pb-8 w-full">
        <img
          src={layananDesign}
          alt="Layanan Desain"
          className="w-[125%] max-w-none h-auto object-contain scale-105"
        />
        <img
          src={designKeterangan}
          alt="Keterangan Desain"
          className="w-[135%] max-w-none h-auto object-contain -mt-[350px] scale-105"
        />
      </div>
      ...
      <div className="flex flex-col items-center text-center pb-8 w-full -mt-[420px]">
        <img
          src={layananBranding}
      ...
      <div className="flex flex-col items-center text-center justify-center w-full self-center -mt-[670px]">
        <span className="bg-black text-white px-2 py-2 block w-fit rounded-none leading-none text-[42px] font-bold tracking-wide uppercase">
          OUR
        </span>
        <span className="bg-black text-white px-2 py-2 block w-fit rounded-none leading-none text-[42px] font-bold tracking-wide uppercase -mt-[15px]">
          SERVICE
        </span>
      </div>

      {/* Row 2, Col 3 - Layanan Sosmed */}
      <div className="flex flex-col items-center text-center pb-8 w-full -mt-[450px]">
        <img
          src={layananSosmed}
